            ...
            <div class="row mb-4">
                ...
                <div class="col">
                    <div>
                        ...
                        <!-- ここでdata-rating属性に評価値を入れる -->
                          <div class="stars" data-rating="{{ number_format($product->averageRating(), 1) }}"></div>
                              <span class="rating-text">{{ number_format($product->averageRating(), 1) }} / 5</span>
                          </div><br>
                        <p>
                            {{$product->description}}
                        </p>
